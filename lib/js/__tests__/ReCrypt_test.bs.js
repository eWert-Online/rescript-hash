...
Jest.describe("Sha512", (function (param) {
        return Jest.describe("make()", (function (param) {
                      Jest.test("\"" + (Caml_array.caml_array_get(tests, 0).input + "\""), (function (param) {
                              return Jest.Expect.toBe(Caml_array.caml_array_get(tests, 0).output, Jest.Expect.expect(ReCrypt_Sha512.make(Caml_array.caml_array_get(tests, 0).input)));
                            }));
                      Jest.test("\"" + (Caml_array.caml_array_get(tests, 1).input + "\""), (function (param) {
                              return Jest.Expect.toBe(Caml_array.caml_array_get(tests, 1).output, Jest.Expect.expect(ReCrypt_Sha512.make(Caml_array.caml_array_get(tests, 1).input)));
                            }));
                      Jest.test("\"" + (Caml_array.caml_array_get(tests, 2).input + "\""), (function (param) {
                              return Jest.Expect.toBe(Caml_array.caml_array_get(tests, 2).output, Jest.Expect.expect(ReCrypt_Sha512.make(Caml_array.caml_array_get(tests, 2).input)));
                            }));
                      return Jest.test("\"" + (Caml_array.caml_array_get(tests, 3).input + "\""), (function (param) {
                                    return Jest.Expect.toBe(Caml_array.caml_array_get(tests, 3).output, Jest.Expect.expect(ReCrypt_Sha512.make(Caml_array.caml_array_get(tests, 3).input)));
                                  }));
                    }));
      }));
