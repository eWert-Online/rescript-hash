...
function make(message) {
  ...
  for(var i = 0 ,i_finish = chunks - 1 | 0; i <= i_finish; ++i){
    ...
    for(var t$2 = 0; t$2 <= 63; ++t$2){
      var temp1 = (((h + ReCrypt_Functions.Sha224_256.sum1(e) | 0) + ReCrypt_Functions.Sha224_256.change(e, f, g) | 0) + Caml_array.caml_array_get(constants, t$2) | 0) + Caml_array.caml_array_get(w, t$2) | 0;
