...
function make(message) {
  ...
  for(var i = 0 ,i_finish = chunks - 1 | 0; i <= i_finish; ++i){
    ...
    for(var j$1 = 0; j$1 <= 63; ++j$1){
      ...
      var temp = b + ReCrypt_Functions.MD5.rotl(((a + f | 0) + Caml_array.caml_array_get(w, g) | 0) + Caml_array.caml_array_get(constants, j$1) | 0, Caml_array.caml_array_get(s, ((j$1 >>> 4) << 2) | j$1 & 3)) | 0;
      a = d;
      d = c;
      c = b;
      b = temp;
