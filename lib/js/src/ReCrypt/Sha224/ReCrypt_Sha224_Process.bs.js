...
function make(message) {
  ...
  for(var i = 0; i < chunks; ++i){
    ...
    Belt_Array.forEachWithIndex(ReCrypt_Sha224_Constants.k, (function(w){
        return function (t, k) {
  ...
  return ReCrypt_Utils.stringToHex(Belt_Array.reduce(ReCrypt_Utils.append32(ReCrypt_Utils.append32(ReCrypt_Utils.append32(ReCrypt_Utils.append32(ReCrypt_Utils.append32(ReCrypt_Utils.append32(ReCrypt_Utils.append32(Belt_Array.make(28, 0), a.contents, 0), b.contents, 4), c.contents, 8), d.contents, 12), e.contents, 16), f.contents, 20), g.contents, 24), "", (function (acc, curr) {
