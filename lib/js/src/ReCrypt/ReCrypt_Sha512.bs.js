...
function make(message) {
  ...
  for(var i = 0 ,i_finish = chunks - 1 | 0; i <= i_finish; ++i){
    ...
    for(var t$2 = 0; t$2 <= 79; ++t$2){
      var temp1 = Caml_int64.add(Caml_int64.add(Caml_int64.add(Caml_int64.add(h, ReCrypt_Functions.Sha384_512.sum1(e)), ReCrypt_Functions.Sha384_512.change(e, f, g)), Caml_array.caml_array_get(constants, t$2)), Caml_array.caml_array_get(w, t$2));
