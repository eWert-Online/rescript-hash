...
function make(message) {
  ...
  var input = Belt_Array.reduce(append32(append32(append32(append32(append32(append32(append32(Belt_Array.make(28, 0), a.contents, 0), b.contents, 4), c.contents, 8), d.contents, 12), e.contents, 16), f.contents, 20), g.contents, 24), "", (function (acc, curr) {
