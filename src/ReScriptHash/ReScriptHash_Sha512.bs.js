...
function make(message) {
  ...
  var input = Belt_Array.reduce(append64(append64(append64(append64(append64(append64(append64(append64(Belt_Array.make(64, 0), a.contents, 0), b.contents, 8), c.contents, 16), d.contents, 24), e.contents, 32), f.contents, 40), g.contents, 48), h.contents, 56), "", (function (acc, curr) {
