...
function make(message) {
  ...
  var input = append64(append64(append64(append64(append64(append64(Belt_Array.make(48, 0), a.contents, 0), b.contents, 8), c.contents, 16), d.contents, 24), e.contents, 32), f.contents, 40).reduce((function (acc, curr) {
